...
// Since we don't have specific kids products in our data,
// I'll use a different subset of the existing products
const KidsCollectionPage = () => {
  // For demonstration, using some of the smaller/accessory items
  ...
  return (
    <div className="py-12">
      <div className="container-custom">
        <div className="mb-12">
          <h1 className="text-4xl font-serif font-bold mb-3">Kids Collection</h1>
